...
const ContactSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      ></LeftIcon>
      <RightIcon1
        className={`right-icon1 absolute ${
          isIntersecting ? "animate-right-icon1" : "scale-0"
        } `}
      ></RightIcon1>
      <RightIcon2
        className={`right-icon2 absolute ${
          isIntersecting ? "animate-right-icon2" : "scale-0"
        }`}
      ></RightIcon2>
      <RightIcon3
        className={`right-icon3 absolute  ${
      ...
      <div className="container mx-auto px-4">
        <div className="contact-left flex flex-col md:flex-row items-start relative">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h2 className="title ml-12  text-3xl font-bold mb-4">
              Let us protect your system
            </h2>
            <p className=" ml-12 description mb-6">
